...
const HowItWorks = () => {
  ...
  const stepperCards: StepperCard[] = steps.map((step) => ({
    ...
    <div className="space-y-3">
        ...
        <div className="h-2 bg-muted rounded-full overflow-hidden">
          <div className="h-full w-3/4 bg-[hsl(16,78%,49%)] rounded-full" />
        </div>
    ...
    <div className="grid grid-cols-3 gap-4">
      ...
      <div key={label} className="text-center">
            <div className="text-2xl font-bold text-[hsl(16,78%,49%)] mb-1">
  ...
  return (
    <section id="how-it-works" ref={sectionRef} className="overflow-hidden bg-background relative !w-[99.9%] !h-[880px] !text-base !py-0">
